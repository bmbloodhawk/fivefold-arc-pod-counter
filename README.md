...
- Host-controlled game start, shared random or host-selected first player, game-time or optional round countdown, player-driven End Turn, and a 15-second handoff undo
