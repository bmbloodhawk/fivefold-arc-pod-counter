...
- Host-controlled game start, shared random first-player selection, game-time or optional round countdown, player-driven End Turn, and a 15-second handoff undo
