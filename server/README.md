...
- Only the active seat owner may hand off the turn. The server records the handoff timestamp and advances to the next living claimed seat, whether that seat is connected or disconnected; only eliminated seats are skipped. Only the player who handed off may undo it, for 15 seconds. The host can pause/resume timers or turn tracking off entirely. Turn actions use exact versions and are broadcast over SSE.
