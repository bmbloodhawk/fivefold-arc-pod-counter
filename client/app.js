...
import { currentAccountToken, googleAccountToken } from './account-auth.js?v=2';
...
const myGamesButton = $('#myGamesButton'); const myGamesDialog = $('#myGamesDialog'); const myGamesStatus = $('#myGamesStatus'); const myGamesContent = $('#myGamesContent'); const myGamesSignInButton = $('#myGamesSignInButton');
let state = null;
