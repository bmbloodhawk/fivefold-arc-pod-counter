...
if (appearancePreviewMode) {
  ...
  const appearanceButtonStyle = document.createElement('style'); appearanceButtonStyle.textContent = '#gameView .end-turn-button{border-color:color-mix(in srgb,var(--brass) calc(var(--appearance-button-border,70) * 1%),transparent);background:color-mix(in srgb,var(--brass) calc(var(--appearance-button-opacity,100) * 1%),transparent);backdrop-filter:blur(calc(var(--appearance-button-blur,0) * 1px))}#gameView .adjust-controls button{border-color:color-mix(in srgb,#62583f calc(var(--appearance-life-button-border,70) * 1%),transparent);background:color-mix(in srgb,var(--surface) calc(var(--appearance-life-button-opacity,100) * 1%),transparent);backdrop-filter:blur(calc(var(--appearance-life-button-blur,0) * 1px))}'; document.head.append(appearanceButtonStyle);
