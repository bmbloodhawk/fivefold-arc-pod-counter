...
const dom = {
  ...
  activeSeatBar: $('#activeSeatBar'), gameMenu: $('#gameMenu'), moreButton: $('#moreButton'), viewCelebrationButton: $('#viewCelebrationButton'), saveGameButton: $('#saveGameButton'),
