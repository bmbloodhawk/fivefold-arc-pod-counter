...
async function showMyGames(signIn = false) {
  ...
  try {
    ...
    const history = (await response.json()).history; enterApp(true); void loadSetupDecks(); exportAccountButton.hidden = false; deleteAccountButton.hidden = false; accountPreferredNameField.hidden = false; saveAccountPreferencesButton.hidden = false;
