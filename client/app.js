...
if (appearancePreviewMode) {
  ...
  const appearanceBaseStyle = document.createElement('style'); appearanceBaseStyle.textContent = 'html.appearance-preview[data-appearance-custom="false"] #gameView .pod-seat{border-radius:7px}html.appearance-preview[data-appearance-custom="false"] #gameView .end-turn-button,html.appearance-preview[data-appearance-custom="false"] #gameView .adjust-controls button{border-radius:5px}'; document.head.append(appearanceBaseStyle);
