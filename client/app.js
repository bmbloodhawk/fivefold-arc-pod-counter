...
if (appearancePreviewMode) {
  ...
  const appearancePreviewStyle = document.createElement('style'); appearancePreviewStyle.textContent = 'html.appearance-preview body{background:radial-gradient(circle at var(--appearance-position,50% 0%),color-mix(in srgb,var(--appearance-atmosphere,#000) calc(var(--appearance-strength,0) * 100%),transparent),transparent 58%),var(--bg);background-size:cover;background-position:center}html.appearance-preview .game-shell{pointer-events:none}html.appearance-preview .counter-stage::after{border-style:var(--appearance-ring-style,solid)}#gameView[data-appearance-ring="none"] .counter-stage::after,#gameView[data-appearance-ring="none"] .counter-sigil{display:none}#gameView[data-appearance-ring="orbit"] .counter-stage::after{border-style:dashed}#gameView[data-appearance-seat="flat"] .pod-seat{border-radius:0;box-shadow:none}#gameView[data-appearance-seat="glass"] .pod-seat{background:color-mix(in srgb,var(--surface) 72%,transparent);backdrop-filter:blur(7px)}#gameView[data-appearance-button="glass"] .end-turn-button{background:color-mix(in srgb,var(--brass) 36%,var(--surface));color:var(--ink);backdrop-filter:blur(8px)}#gameView[data-appearance-button="outline"] .end-turn-button{background:transparent;color:var(--brass)}.mode-nav img{width:22px;height:22px;object-fit:contain}.mode-nav button>span{font-size:1.4rem}.counter-sigil img{width:100%;height:100%;object-fit:contain}'; document.head.append(appearancePreviewStyle);
  const appearanceSeatStyle = document.createElement('style'); appearanceSeatStyle.textContent = '#gameView .pod-seat{border-color:color-mix(in srgb,#5b594f calc(var(--appearance-seat-border,70) * 1%),transparent);background:color-mix(in srgb,var(--surface) calc(var(--appearance-seat-opacity,100) * 1%),transparent);backdrop-filter:blur(calc(var(--appearance-seat-blur,0) * 1px))}#gameView[data-appearance-seat="glass"] .pod-seat{background:color-mix(in srgb,var(--surface) calc(var(--appearance-seat-opacity,100) * .72%),transparent)}'; document.head.append(appearanceSeatStyle);
  const appearanceButtonStyle = document.createElement('style'); appearanceButtonStyle.textContent = '#gameView .end-turn-button{border-color:color-mix(in srgb,var(--brass) calc(var(--appearance-button-border,70) * 1%),transparent);background:color-mix(in srgb,var(--brass) calc(var(--appearance-button-opacity,100) * 1%),transparent);backdrop-filter:blur(calc(var(--appearance-button-blur,0) * 1px))}#gameView .adjust-controls button{border-color:color-mix(in srgb,#62583f calc(var(--appearance-life-button-border,70) * 1%),transparent);background:color-mix(in srgb,var(--surface) calc(var(--appearance-life-button-opacity,100) * 1%),transparent);backdrop-filter:blur(calc(var(--appearance-life-button-blur,0) * 1px))}#gameView .custom-life-button{border-color:color-mix(in srgb,#62583f calc(var(--appearance-custom-life-border,70) * 1%),transparent);background:color-mix(in srgb,var(--surface) calc(var(--appearance-custom-life-opacity,100) * 1%),transparent);backdrop-filter:blur(calc(var(--appearance-custom-life-blur,0) * 1px))}#gameView .commander-tax-quick button{border-color:color-mix(in srgb,#62583f calc(var(--appearance-commander-tax-border,70) * 1%),transparent);background:color-mix(in srgb,var(--surface) calc(var(--appearance-commander-tax-opacity,100) * 1%),transparent);backdrop-filter:blur(calc(var(--appearance-commander-tax-blur,0) * 1px))}'; document.head.append(appearanceButtonStyle);
