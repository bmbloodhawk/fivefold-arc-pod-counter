...
if (appearancePreviewMode) {
  ...
  window.addEventListener('message', event => {
    ...
    Object.entries({ podStrip: 'pod-strip', counterReadout: 'counter-readout', dialSurface: 'dial-surface', turnActions: 'turn-actions', adjustControls: 'adjust-controls', customLife: 'custom-life', commanderTax: 'commander-tax', modeNav: 'mode-nav' }).forEach(([key, css]) => {
