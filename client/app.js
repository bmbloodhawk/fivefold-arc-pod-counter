...
signInButton.addEventListener('click', () => { myGamesDialog.showModal(); showMyGames(); }); continueGuestButton.addEventListener('click', enterApp);
...
myDecksButton.addEventListener('click', () => { myDecksDialog.showModal(); showMyDecks(); });
