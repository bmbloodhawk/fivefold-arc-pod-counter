...
if (appearancePreviewMode) {
  ...
  if (phoneLayoutSessionId) {
    const editorStyle = document.createElement('style'); editorStyle.textContent = 'html.appearance-preview .phone-layout-editor{position:fixed;z-index:30;right:10px;bottom:calc(12px + env(safe-area-inset-bottom));left:10px;max-height:48dvh;overflow:auto;padding:12px;border:1px solid var(--brass);border-radius:10px;background:rgb(16 16 15 / .96);box-shadow:0 14px 40px #000c;pointer-events:auto;color:var(--ink)}html.appearance-preview .phone-layout-editor header{display:flex;justify-content:space-between;gap:8px;align-items:center}html.appearance-preview .phone-layout-editor strong{color:var(--brass);font-size:.82rem}html.appearance-preview .phone-layout-editor button{min-height:32px;padding:5px 8px;border:1px solid var(--brass-dark);border-radius:5px;background:var(--surface);color:var(--ink);font-weight:800}.phone-layout-editor details{margin-top:8px;border-top:1px solid var(--line)}.phone-layout-editor summary{padding:8px 0;color:var(--brass);font-size:.75rem;font-weight:800}.phone-layout-editor label{display:grid;grid-template-columns:1fr auto;gap:6px;align-items:center;margin:8px 0;color:var(--ink);font-size:.72rem}.phone-layout-editor input,.phone-layout-editor select{accent-color:var(--brass)}.phone-layout-editor input[type=range]{width:120px}.phone-layout-editor output{color:var(--brass);font-size:.7rem}'; document.head.append(editorStyle);
