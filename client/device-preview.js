...
export function mountDevicePreview({ primaryFrame, getSkin }) {
  ...
  panel.innerHTML = `<div class="device-preview-heading"><div><p class="kicker">DEVICE PREVIEW</p><h2>Phone Simulator</h2><p class="helper">Live app renderer at the selected CSS viewport. Use this for responsive-layout comparison; confirm final visual details in the real phone browser.</p></div><span id="devicePreviewMeta" class="device-preview-meta"></span></div>
